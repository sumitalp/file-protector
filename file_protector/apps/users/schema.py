...
from file_protector.apps.users.config import TOKEN_PAIR_RESPONSE_SCHEMA
from file_protector.apps.users.views import TokenBlackListPairView, TokenObtainPairView
